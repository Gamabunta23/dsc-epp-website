...
const locations: Location[] = [
  ...
  },
  {
    ...
    phone: "+49 40 80 90 35 611",
    whatsapp: "+49 151 72 82 22 91",
    email: "info@dsc-logistik.de",
    legacy: "Standort der DSC Logistik GmbH",
  },
  {
    name: "Ostwestfalen-Lippe",
    role: "Inland-Hub",
    desc: "Zentral im westfälischen Wirtschaftsraum. Just-in-Time-Anlieferung an Industrie und Handel.",
    phone: "+49 52 52 93 33 443",
    whatsapp: "+49 171 10 01 119",
    email: "info@epp-logistik.de",
    legacy: "Standort der EPP Logistik GmbH",
  },
];
